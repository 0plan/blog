...
<img src="https://github.com/0plan/blog/blob/main/assets/images/post-cards/베스트앨범-ddf8ff.png?raw=true" alt="베스트엘범" />
...
```mermaid
flowchart TD
    A["genres, plays 입력"] --> B["장르별 총 재생 횟수 및\n노래 목록 집계"]
    B --> C["장르를 총 재생 횟수 기준\n내림차순 정렬"]
    C --> D["각 장르 내 노래를\n재생 횟수 내림차순,\n고유 번호 오름차순 정렬"]
    D --> E["장르별 상위 2곡 선택"]
    E --> F["result 배열에 순서대로 추가"]
```
