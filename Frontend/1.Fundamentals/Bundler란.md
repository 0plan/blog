...
| 특징 | Webpack | Vite | Parcel | ESBuild |
| :--- | :--- | :--- | :--- | :--- |
| **속도 (Dev)** | 느림 (번들링 필요) | 매우 빠름 (Native ESM) | 빠름 | 매우 빠름 (Go 기반) |
| **설정** | 복잡함 (유연성 높음) | 간단함 (기본 최적화) | 거의 없음 (Zero Config) | 간단함 |
| **생태계** | 매우 방대함 | 빠르게 성장 중 | 적당함 | 라이브러리 위주 |
| **주요 용도** | 대규모 프로젝트 | 현대적 웹 앱 (React, Vue) | 빠른 프로토타이핑 | 고속 빌드 도구 |
