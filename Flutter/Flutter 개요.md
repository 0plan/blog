...
### 단점 (Cons)
- **앱 용량**: 엔진을 포함해야 하므로 네이티브 앱보다 초기 설치 용량이 큼.
- **새로운 언어(Dart)**: Java나 Kotlin에 익숙한 개발자에게는 초기 학습 비용 발생.
- **네이티브 기능 연동**: 매우 최신이거나 특수한 하드웨어 제어 기능의 경우 Platform Channel을 직접 구현해야 할 수 있음.
